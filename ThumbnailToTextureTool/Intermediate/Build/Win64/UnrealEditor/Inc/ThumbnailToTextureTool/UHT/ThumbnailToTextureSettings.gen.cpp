...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UThumbnailToTextureSettings_Statics::NewProp_RootTexture2DSaveDir = { "RootTexture2DSaveDir", nullptr, (EPropertyFlags)0x0010000000004005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(UThumbnailToTextureSettings, RootTexture2DSaveDir), Z_Construct_UScriptStruct_FDirectoryPath, METADATA_PARAMS(Z_Construct_UClass_UThumbnailToTextureSettings_Statics::NewProp_RootTexture2DSaveDir_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UThumbnailToTextureSettings_Statics::NewProp_RootTexture2DSaveDir_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UThumbnailToTextureSettings_Statics::NewProp_ThumbnailPrefix = { "ThumbnailPrefix", nullptr, (EPropertyFlags)0x0010000000004005, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(UThumbnailToTextureSettings, ThumbnailPrefix), METADATA_PARAMS(Z_Construct_UClass_UThumbnailToTextureSettings_Statics::NewProp_ThumbnailPrefix_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UThumbnailToTextureSettings_Statics::NewProp_ThumbnailPrefix_MetaData)) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UThumbnailToTextureSettings_Statics::ClassParams = {
		...
		0,
		0x001000A6u,
		METADATA_PARAMS(Z_Construct_UClass_UThumbnailToTextureSettings_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UThumbnailToTextureSettings_Statics::Class_MetaDataParams))
	};
	...
	struct Z_CompiledInDeferFile_FID_Projects_TowerShooterGame_TowerShooter_Plugins_ThumbnailToTextureTool_Source_ThumbnailToTextureTool_Public_ThumbnailToTextureSettings_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Projects_TowerShooterGame_TowerShooter_Plugins_ThumbnailToTextureTool_Source_ThumbnailToTextureTool_Public_ThumbnailToTextureSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UThumbnailToTextureSettings, UThumbnailToTextureSettings::StaticClass, TEXT("UThumbnailToTextureSettings"), &Z_Registration_Info_UClass_UThumbnailToTextureSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UThumbnailToTextureSettings), 3554123545U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Projects_TowerShooterGame_TowerShooter_Plugins_ThumbnailToTextureTool_Source_ThumbnailToTextureTool_Public_ThumbnailToTextureSettings_h_488441305(TEXT("/Script/ThumbnailToTextureTool"),
		Z_CompiledInDeferFile_FID_Projects_TowerShooterGame_TowerShooter_Plugins_ThumbnailToTextureTool_Source_ThumbnailToTextureTool_Public_ThumbnailToTextureSettings_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Projects_TowerShooterGame_TowerShooter_Plugins_ThumbnailToTextureTool_Source_ThumbnailToTextureTool_Public_ThumbnailToTextureSettings_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
